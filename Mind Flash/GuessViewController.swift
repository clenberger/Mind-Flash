...
class GuessViewController: UIViewController {
    ...
    func loadQuestions() {
        ...
        let question2 = Question(questionText: "What is Stephen Hawkings birthday?", answers: ["January 8th", "September 10th", "December 6th", "June 11th"], correctAnswer: 0)
    ...
    @IBAction func resetButtonTapped(_ sender: Any) {
        let alertView = UIAlertController(title: "Reset", message: "Are you sure you would like to reset?", preferredStyle: .alert)
    ...
    @IBAction func answerButtonTapped(_ sender: Any) {
        ...
        if button.title(for: .normal) == displayedQuestion!.answers[(displayedQuestion!.correctAnswer)] {
          ...
          self.present(alertView, animated: true, completion: nil)
            ...
            let alertView = UIAlertController(title: "WRONG", message: "You got the answer wrong, good job!", preferredStyle: .alert)
